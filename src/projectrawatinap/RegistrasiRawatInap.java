...
public class RegistrasiRawatInap {
    ...
    public void registerPasien() throws SQLException, IOException {
        ...
        k.query = "insert into pasien values('"+no_pasien+"','"+nama+"','"+jenis_kelamin+"','"+tgl_lahir+"','"+no_telp+"','"+alamat+"','"+pekerjaan+"','0');";
        k.crud();
        if(k.count>0){
    ...
    public void registerRawat() throws SQLException, IOException {
        ...
        System.out.print("│  2. Tanggal Rawat : " + tgl + " Ubah? : ");
        tgl = reader.readLine();
        if (tgl.equals("")) {
            tgl = java.time.LocalDate.now().toString();
        }
        mpas.tampilPasienRawat();
        System.out.print("│  3. Masukan ID Pasien : ");
        no_pasien = reader.readLine();
        System.out.println("Kamar Tersedia :");
        mk.tampilKamarTersedia();
        System.out.print("│  4. Masukan KD Kamar : ");
        kd_kamar = reader.readLine();
        System.out.print("│  5. Masukan ID Perawat yang mengurus : ");
        id_perawat = reader.readLine();
        System.out.print("│  6. Masukan ID Dokter : ");
        id_dokter = reader.readLine();
